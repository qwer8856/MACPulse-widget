...
当前版本：**3.1.0**。安装后的应用和小组件名称均为 **“系统状态”**。

## 下载安装

**[下载安装包：MacPulse Widget 3.1.0（M 系列 Mac）](https://github.com/qwer8856/MACPulse-widget/releases/download/v3.1.0/MACPulse-Widget-v3.1.0-macOS-arm64.zip)**

[版本发布页与校验文件](https://github.com/qwer8856/MACPulse-widget/releases/tag/v3.1.0)
...
**点击右上角菜单栏，即可查看每个逻辑核心的 CPU 百分比、内存、磁盘、供电功率和电池信息**，无需先打开资源窗口。核心较多时可滚动查看；电池信息包含系统可提供的电量、充电/供电状态、预计时间和健康状态，无内置电池的 Mac 会明确显示。菜单已移除“刷新小组件”和“查看小组件状态”入口，资源窗口也不再显示手动刷新小组件按钮。
...
<img src="docs/images/menu-light.png" width="380" alt="菜单栏中的各核心 CPU、内存、磁盘、电池信息及连续多选">
