...
当前版本：**3.4.1**。安装后的应用和小组件名称均为 **“系统状态”**。

## 下载安装

**[下载安装包：MacPulse Widget 3.4.1（M 系列 Mac）](https://github.com/qwer8856/MACPulse-widget/releases/download/v3.4.1/MACPulse-Widget-v3.4.1-macOS-arm64.zip)**

[版本发布页与校验文件](https://github.com/qwer8856/MACPulse-widget/releases/tag/v3.4.1)
