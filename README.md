...
当前版本：**3.0.0**。安装后的应用和小组件名称均为 **“系统状态”**。

## 下载安装

**[下载安装包：MacPulse Widget 3.0.0（M 系列 Mac）](https://github.com/qwer8856/MACPulse-widget/releases/download/v3.0.0/MACPulse-Widget-v3.0.0-macOS-arm64.zip)**

[版本发布页与校验文件](https://github.com/qwer8856/MACPulse-widget/releases/tag/v3.0.0)
...
<img src="docs/images/menu-light.png" width="300" alt="支持连续多选显示内容的菜单栏详情">
<img src="docs/images/menu-dark.png" width="300" alt="深色菜单栏详情">
